    ...
    <div class="container-fluid">
        <div class="row mt-4">
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle text-center">
                                                    <form action="{{ route('cart.store') }}" method="POST">
                                                        ...
                                                        <input type="hidden" value="{{ $b->stok}}" name="quantity">
            ...
            <div class="col-lg-12 mt-4">
                <div class="card z-index-2 h-100">
                    <div class="card-header pb-0 pt-3 bg-transparent">
                        <h6 class="text-capitalize text-center">CART</h6>
                    </div>
                    <div class="card-body p-3">
                        <div class="chart">
                            <div class="table-responsive">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="staticBackdropLabel1">CART</h1>
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('cart.pay') }}" method="POST">
                        ...
                        <div class="form-group mt-4">
                            <input type="number" min="0" class="form-control" id="total_bay" name="total_bay"
